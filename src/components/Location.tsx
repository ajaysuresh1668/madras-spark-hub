      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-8 border-2 border-primary/20 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-700 to-purple-800 flex items-center justify-center flex-shrink-0">
              ...
              <div className="mt-8 p-4 bg-primary/5 rounded-xl border-2 border-primary/20">
                <p className="text-sm font-semibold text-foreground mb-1">
                  TNEA Counselling Code
                </p>
                <p className="text-3xl font-bold text-primary">1203</p>
              </div>
            </div>
          </div>

          {/* Google Maps */}
          <div className="bg-white rounded-2xl overflow-hidden border-2 border-primary/20 shadow-lg h-[500px]">
            <iframe
